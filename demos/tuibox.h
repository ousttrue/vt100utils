...
inline int vec_reserve_po2_(char **data, int *length, int *capacity, int memsz,
                     int n) {
  int n2 = 1;
  if (n == 0)
    return 0;
...
inline int vec_insert_(char **data, int *length, int *capacity, int memsz, int idx) {
...
inline void vec_splice_(char **data, int *length, int *capacity, int memsz, int start,
                 int count) {
  (void)capacity;
...
inline void vec_swap_(char **data, int *length, int *capacity, int memsz, int idx1,
               int idx2) {
